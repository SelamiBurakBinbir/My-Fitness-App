...
// Veritabanı bağlantısı, fitnessdb veritabanı kullanılarak
const pool = new Pool({
  user: "postgres",
  host: "localhost",
  database: "fitnessdb",
...
async function createTables() {
  try {
    ...
    /********************************************************
     * EXERCISES
     *    Önce eski tablo siliniyor, sonra yeniden oluşturuluyor.
     ********************************************************/
    await pool.query(`
...
// Veritabanının varlığını kontrol et, sonra tabloları oluştur.
